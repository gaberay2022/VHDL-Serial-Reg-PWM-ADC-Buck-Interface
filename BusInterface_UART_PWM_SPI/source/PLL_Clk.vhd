...
-- Module  Version: 5.7
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n PLL_Clk -lang vhdl -synth lse -arch se5c00 -type pll -fin 8.31 -fclkop 25 -fclkop_tol 0.5 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -lock -sticky 
...
architecture Structure of PLL_Clk is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "24.930000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "8.310000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        PLL_LOCK_MODE=>  2, CLKOS_TRIM_DELAY=>  0, CLKOS_TRIM_POL=> "FALLING", 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  21, CLKFB_DIV=>  3, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MachXO3D;
configuration Structure_CON of PLL_Clk is
    for Structure
